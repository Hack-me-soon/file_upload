    ...
    form.parse(req, async (err, fields, files) => {
        ...
        try {
            ...
            await git.commit({
                ...
                author: { name: 'OneByOne Bot', email: 'bot@render.com' }
            });
            ...
            // 3. CLEANUP EVERYTHING BEFORE RESPONDING
            await fs.remove(WORK_DIR);
            console.log(`✅ Finished: ${fileName}`);
            
            // 4. NOW tell the browser we are ready for the next file
            res.status(200).json({ success: true, message: "Server RAM is clear." });
